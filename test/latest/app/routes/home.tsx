...
export default function Home() {
  ...
  const parsed_var_names = data?.var_names as string[];
  const parsed_description = data?.description as string[];
  const parsed_units = data?.possible_values_and_description as string[];
      ...
      <div>
        <label className="block mb-3">
          ...
          <input
            ...
            onChange={e => setXptFile(e.target.files?.[0] || null)}
          />
        </label>
      </div>
...
{parsed_var_names && parsed_var_names.length > 0 && (
